  ...
  <div class="shopcart-wrapper">
    <div class="shopcart">
      ...
      <div class="ball-container">
        <transition v-for="(ball, index) in balls" name="drop" @before-enter="beforeEnter" @enter="enter"
                    @after-enter="afterEnter" :key="'ball' + index">
    ...
    computed: {
      ...
      listShow () {
        ...
        if (show) {
          this.$nextTick(() => {
            if (!this.scroll) {
              this.scroll = new Scroll(this.$el.querySelector('.list-content-hook'), {
                click: true
              })
            } else {
              this.scroll.refresh()
